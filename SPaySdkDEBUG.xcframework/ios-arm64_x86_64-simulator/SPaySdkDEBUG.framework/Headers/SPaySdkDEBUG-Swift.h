...
- (nonnull instancetype)initWithApiKey:(NSString * _Nonnull)apiKey merchantLogin:(NSString * _Nonnull)merchantLogin bankInvoiceId:(NSString * _Nonnull)bankInvoiceId orderNumber:(NSString * _Nonnull)orderNumber bindingId:(NSString * _Nonnull)bindingId OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
+ (void)payWithBindingWith:(UIViewController * _Nonnull)viewController paymentRequest:(SBindingPaymentRequest * _Nonnull)paymentRequest completion:(void (^ _Nonnull)(enum SPayState, NSString * _Nonnull, NSString * _Nullable))completion;
